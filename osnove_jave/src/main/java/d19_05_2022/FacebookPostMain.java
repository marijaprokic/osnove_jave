...
import d20_05_2022.FacebookPost;
...
public class FacebookPostMain {
    public static void main(String[] args) {
        ...
        objava1.tekstObjave = "Trebao sam da skrenem levo od Albukerkija...";
        objava1.brojLajkova = 100;
        objava1.brojDeljenja = 200;

        FacebookPost objava2 = new FacebookPost();
        objava2.imePrezimeKorisnika = "Marija Prokić";
        objava2.imePrezimeKorisnikaObjava = "Elmer lovac";
        objava2.tekstObjave = "Da li da ga upucam sad, ili kad dodjem kući?";
        objava2.brojLajkova = 1000;
        objava2.brojDeljenja = 2000;
